...
****19th June 2026****
  - Added optional address & other fields in search call.
  - Added driver name, photo, rating once a driver is assigned.
  - Added names and images to provider details.
  - Added invoice document on ride completion.
