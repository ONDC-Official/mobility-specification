...
****19th June 2026****
  - Added address & other fields in search call(optional).
  - Added driver name, photo, rating once a driver is assigned(optional).
  - Added names and images to provider details(optional).
  - Added invoice document on ride completion(optional).
